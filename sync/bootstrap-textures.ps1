...
# into MindAttic.Components/cyberspace/assets/ as lossless copies. The textures are
...
param(
    ...
    [string]$DestDir   = 'D:/Projects/MindAttic/MindAttic.Components/cyberspace/assets'
)
