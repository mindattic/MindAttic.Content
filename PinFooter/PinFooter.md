...
```html
<link  rel="stylesheet" href="https://cdn.jsdelivr.net/gh/mindattic/MindAttic.Components@v1.0.0/PinFooter/pin-footer.css">
<script src="https://cdn.jsdelivr.net/gh/mindattic/MindAttic.Components@v1.0.0/PinFooter/pin-footer.js" defer></script>
```
...
`<!-- BEGIN MINDATTIC.COMPONENTS:PINFOOTER --> … <!-- END … -->` markers in
