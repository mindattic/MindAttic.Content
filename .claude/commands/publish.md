---
description: Publish (fan out) every subscribed component into mindattic.com, StreetSamurai, Claudia, ChiMesh, and any other subscribers. Alias for /sync — neither is an FTP deploy; this only pushes component sources into sibling repos.
---
